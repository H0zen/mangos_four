...
enum LogFilters
{
    ...
    LOG_FILTER_DECK_MINIONS       = 0x800000,               // 23 pets/totems reconciled across a vessel map boundary
};
...
class Log : public MaNGOS::Singleton<Log>
{
    ...
    public:
        ...
        */
         ...
         *        WorldSession::SendPacket (outgoing), where opcode names are
         *        available. The transport remains game-agnostic.
         * @return bool
         */
