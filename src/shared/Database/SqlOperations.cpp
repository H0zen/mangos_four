...
/**
 * @brief Take the connection's lock, then do the work.
 *
 * The lock lives here and nowhere else, so an operation cannot forget it and a transaction
 * cannot take it twice. Subclasses implement ExecuteLocked().
 */
