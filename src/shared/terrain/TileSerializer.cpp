...
namespace world::terrain
{
    namespace
    {
        // "MNG4" in file order. Its own magic, not 03's: the hole map is 64 bits per
        // chunk here, so a tile baked by a sibling core would read as a valid file
        // and mis-parse every field after the heights.
        constexpr uint32_t MAGIC = 0x34474E4D;
