...
namespace world::terrain
{
    namespace
    {
        ...
        // The MD20 header shrank on the way to 3.3.5a: version 264 dropped
        // playable_animation_lookup (8 bytes), narrowed skin_profiles to a count (4)
        // and dropped texture_flipbooks (8), moving the collision block from 236 to
        // 216. It has not moved since -- 5.4.8's version 272 keeps the 264 prefix, so
        // collisionIndices is still at 0x0D8. Reading a model at the 2.4.3 offset
        // yields plausible-looking counts and a hull made of garbage, with no error
        // anywhere.
