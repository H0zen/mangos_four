...
namespace world::terrain
{
    ...
    public:
        MpqTileSource(IMpqArchive& archive, const world::MapDbcStore* maps,
                      ...
                      const world::LiquidObjectStore* liquidObjects = nullptr)
            : m_archive(archive), m_maps(maps), m_liquidTypes(liquidTypes),
              m_liquidObjects(liquidObjects), m_wmo(archive, liquidTypes),
              m_m2(archive) {}
    ...
    private:
        ...
        const world::LiquidObjectStore* m_liquidObjects;
        WmoLoader m_wmo;
        M2Loader m_m2;
