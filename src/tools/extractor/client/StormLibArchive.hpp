...
namespace world::terrain
{
    ...
    // The 5.4.8 chain. Mists groups the bases by CONTENT TYPE -- base/world/model/
    // texture/misc/expansion1-4 -- rather than by world region, ships a single locale
    // archive, and carries eighteen wow-update-* builds of PTCH deltas.
