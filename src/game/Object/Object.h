...
class WorldObject : public Object
{
    ...
    public:
        ...
        // The old coordinate-owning API, for SD3, Eluna and the bots only. See the
        // file's header.
#include "Object/ScriptApiCompat.inl"
    ...
    protected:
        ...
        // these functions are used mostly for Place().MoveTo() and Corpse/Player specific stuff...
...
// phasing and world membership are game state, line of sight is a terrain question, and a
...
/// Can A reach B -- a common frame and a shared phase are required. Melee, spells,
/// threat, aggro.
