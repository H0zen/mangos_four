...
enum ResponseCodes
{
    ...
    // 5.4.8 adds a trial-account rejection here. Omitting it shifted every code
    // below down by one, which is what broke character deletion: the server
    // answered SMSG_CHAR_DELETE with 71, and 71 is CHAR_DELETE_IN_PROGRESS in
    // 18414, so the client never saw success and reported result=FALSE while the
    // character had in fact already been removed from the database.
    CHAR_CREATE_TRIAL                                      = 0x46,

    CHAR_DELETE_IN_PROGRESS                                = 0x47,
    CHAR_DELETE_SUCCESS                                    = 0x48,
    CHAR_DELETE_FAILED                                     = 0x49,
    CHAR_DELETE_FAILED_LOCKED_FOR_TRANSFER                 = 0x4A,
    CHAR_DELETE_FAILED_GUILD_LEADER                        = 0x4B,
    CHAR_DELETE_FAILED_ARENA_CAPTAIN                       = 0x4C,
    CHAR_DELETE_FAILED_HAS_HEIRLOOM_OR_MAIL                = 0x4D,

    CHAR_LOGIN_IN_PROGRESS                                 = 0x4E,
    CHAR_LOGIN_SUCCESS                                     = 0x4F,
    CHAR_LOGIN_NO_WORLD                                    = 0x50,
    CHAR_LOGIN_DUPLICATE_CHARACTER                         = 0x51,
    CHAR_LOGIN_NO_INSTANCES                                = 0x52,
    CHAR_LOGIN_FAILED                                      = 0x53,
    CHAR_LOGIN_DISABLED                                    = 0x54,
    CHAR_LOGIN_NO_CHARACTER                                = 0x55,
    CHAR_LOGIN_LOCKED_FOR_TRANSFER                         = 0x56,
    CHAR_LOGIN_LOCKED_BY_BILLING                           = 0x57,
    CHAR_LOGIN_LOCKED_BY_MOBILE_AH                         = 0x58,
    ...
    CHAR_NAME_SUCCESS                                      = 0x5C,
    CHAR_NAME_FAILURE                                      = 0x5D,
    CHAR_NAME_NO_NAME                                      = 0x5E,
    CHAR_NAME_TOO_SHORT                                    = 0x5F,
    CHAR_NAME_TOO_LONG                                     = 0x60,
    CHAR_NAME_INVALID_CHARACTER                            = 0x61,
    CHAR_NAME_MIXED_LANGUAGES                              = 0x62,
    CHAR_NAME_PROFANE                                      = 0x63,
    CHAR_NAME_RESERVED                                     = 0x64,
    CHAR_NAME_INVALID_APOSTROPHE                           = 0x65,
    CHAR_NAME_MULTIPLE_APOSTROPHES                         = 0x66,
    CHAR_NAME_THREE_CONSECUTIVE                            = 0x67,
    CHAR_NAME_INVALID_SPACE                                = 0x68,
    CHAR_NAME_CONSECUTIVE_SPACES                           = 0x69,
    CHAR_NAME_RUSSIAN_CONSECUTIVE_SILENT_CHARACTERS        = 0x6A,
    CHAR_NAME_RUSSIAN_SILENT_CHARACTER_AT_BEGINNING_OR_END = 0x6B,
    CHAR_NAME_DECLENSION_DOESNT_MATCH_BASE_NAME            = 0x6C
};
