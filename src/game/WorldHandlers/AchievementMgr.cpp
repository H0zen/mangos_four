    ...
    class AchievementChatBuilder
    {
        public:
            ...
            void operator()(WorldPacket& data, int32 loc_idx)
            {
                ...
                ChatHandler::BuildChatPacket(data, i_msgtype, text, LANG_UNIVERSAL, i_player.GetChatTag(), i_player.GetObjectGuid(), i_player.GetName(), i_player.GetObjectGuid(), NULL, NULL,
                    i_achievementId);
            }
